...
echo "${yellowf}This is a phrase in yellow ${redb} and Red${reset}"
echo "${boldon} This is in BOLD${ulon} this is in italics${reset} Normal Text HERE."
echo "${invon}This is inv${invoff} and this is not"
echo "${yellowf}${redb}Warning I ${yellowb}${redf} Warning II${reset}"
